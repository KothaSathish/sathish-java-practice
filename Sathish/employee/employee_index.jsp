...
<table width="101%" border="1" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td> <div align="center"><a href="employee/employee_index1.jsp">Home</a> |<a href="employee/changepassw.jsp">Change Password</a>| <a href="employee/view_profile.jsp">View Profile</a> | <a href="employee/edit_profile.jsp">Update Profile</a>| <a href="home.jsp">LogOut</a></div>
      <table width="100%" border="1">
        <tr>
          <td width="19%"><table width="93%" height="106" border="1">
            ...
            <tr>
              <td><div align="center"><a href="employee/completed_training.jsp">Completed Training(<%=count%>)</a></div></td>
            </tr>
			<%
			...
			%>
            <tr>
              <td><div align="center"><a href="employee/scheduled_training.jsp">Scheduled Training(<%=count1%>)</a></div></td>
            </tr>
          </table></td>
          <td width="81%"></p>
