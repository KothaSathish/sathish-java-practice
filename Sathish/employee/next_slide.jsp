...
<%
  ...
  rs2=st2.executeQuery("select * from training2 where id='"+course+"'");
  %>
<form action="next_slide.jsp" method="post">
...
%>
  <tr>
    <td width="49%"><img src="<%=rs2.getString("image")%>" width="500" height="600" alt="<%=rs2.getString("image")%>"/></td>
  </tr>
  <TD align="center"><a href="next_slide.jsp?id=<%=rs2.getString(1)%>">Privious</a>
  <a href="next_slide.jsp?id=<%=rs2.getString(1)%>">Next</a></TD>
