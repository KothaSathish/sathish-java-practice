...
<div class="wrapper row3">
  <div id="container" class="clear">
	...
	try{
		...
		String SQL="select * from allocate A,training T where A.status='Incomplete' and A.employee='"+email+"' and A.tname=T.id";
		rs2=st2.executeQuery("select * from allocate A,training T where A.status='Incomplete' and A.employee='"+email+"' and A.tname=T.id");
  // out.print(SQL);
  %>
...
%>
        <tr class="<%=abc %>">
          ...
          <td><a href="gothrough_training.jsp?id=<%=rs2.getString(11)%>">InCompleted</a></td>
        </tr>
        <%
count++;
 }
